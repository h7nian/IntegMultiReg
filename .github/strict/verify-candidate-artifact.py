...
expected = {
 ...
 'IntegMultiReg_0.2.0.tar.gz': '00d557a648f27663996fbd6e9270759d3499b59e693b9388d07268d00c00cec2'
}
...
with tarfile.open(fixtures/'IntegMultiReg_0.2.0.tar.gz') as archive:
    ...
    assert b'Version: 0.2.0' in archive.extractfile('IntegMultiReg/DESCRIPTION').read()
